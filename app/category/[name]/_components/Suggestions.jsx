        ...
        {picks.map((category, i) => {
          ...
          return (
            <Link href={`/category/${category}`} key={i}>
              <div className={`group cursor-pointer relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-[1.02] hover:-translate-y-1 h-full`}>
